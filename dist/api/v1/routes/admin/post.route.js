...
const controller = __importStar(require("../../controllers/admin/post.controller"));
...
router.patch('/edit/:id', uploadCloud_middleware_1.upload.single('image'), uploadCloud_middleware_1.uploadToCloudinary, controller.edit);
